...
export const metadata: Metadata = {
  ...
  description: "Experience the finest hand-picked coffee beans roasted to perfection. Shop premium coffee, espresso, mochas, lattes, and milkshakes online.",
  keywords: "coffee, espresso, mocha, latte, milkshake, freshly roasted, premium coffee",
  openGraph: {
    title: "Black Coffee - Premium Freshly Roasted Coffee",
